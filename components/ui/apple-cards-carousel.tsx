                    ...
                    <AnimatePresence>
                        {open && (
                            <div className="fixed inset-0 z-[100] h-screen overflow-auto">
                                ...
                                >
                                    <button
                                        className="sticky top-4 right-0 ml-auto flex h-8 w-8 items-center justify-center rounded-full bg-black dark:bg-white hover:opacity-80 transition-opacity"
                                        onClick={handleClose}
                                    >
                                    ...
                                    <motion.p
                                        ...
                                        className="text-base font-medium text-black dark:text-white uppercase tracking-widest opacity-60"
                                    >
                                        {card.category}
                                    </motion.p>
                                    <motion.p
                                        layoutId={layout ? `title-${card.title}` : undefined}
                                        className="mt-4 text-2xl font-serif font-light text-neutral-700 md:text-5xl dark:text-white"
                                    >
                                        {card.title}
                                    </motion.p>
                    ...
                    <div className="relative z-40 p-8 flex flex-col h-full justify-between">
                        <div>
                            <motion.p
                                ...
                                className="text-left font-sans text-xs font-medium text-white md:text-sm uppercase tracking-widest opacity-80"
                            >
                                {card.category}
                            </motion.p>
                            <motion.p
                                layoutId={layout ? `title-${card.title}` : undefined}
                                className="mt-2 max-w-xs text-left font-serif text-xl font-light [text-wrap:balance] text-white md:text-3xl"
                            >
                                {card.title}
                            </motion.p>
                        </div>
